    ...
    return (
      <Container>
        ...
        {!this.props.carts.isLoading &&
          this.props.carts.data.map((v) => (
            <div
              className="shadow mt-2 col-sm-12"
              style={{
                display: "flex",
                ...
                <Col style={{ alignSelf: "center" }}>
                  <Nav style={{ width: "100%" }}>
                    <div className="cold-md-5">
                      <Button
                        color="success"
                        onClick={() => this.buttonMin(v.item_id)}
                    ...
                    <div key={v.item_id} className="cold-md-2">
                      <Input
                        ...
                        onChange={this.handleChange[v.item_id]}
                        value={v.quantity}
                      ></Input>
                    </div>
                    <div className="cold-md-5">
                      <Button
                        color="success"
                        onClick={() => this.buttonPlus(v.item_id)}
                      >
                        <b>+</b>
                      </Button>
                    </div>
                    <div className="cold-md-5"></div> &nbsp;
        ...
        >
          ...
          >
            ...
            <Link to={`/review/${id_user}`} className="text-light text-center">
