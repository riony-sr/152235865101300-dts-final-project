        ...
        <NB color="light" light expand="md" className="shadow fixed-top">
          ...
          <Collapse isOpen={navCollapsible} navbar>
            <Nav className="mr-auto" navbar>
              <NavItem>
                <Link className="nav-link text-success" to="/menu">
                  Menu
                </Link>
              </NavItem>
              <NavItem>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  <DropdownItem>
                    <Link className="nav-link" to="/searchbyname">
                      Name
                    </Link>
                  </DropdownItem>
                  <DropdownItem>
                    <Link className="nav-link" to="/searchbyprice">
                      Price
                    </Link>
                  </DropdownItem>
                  <DropdownItem>
                    <Link className="nav-link" to="/searchbyrating">
                      Rating
                    </Link>
                  </DropdownItem>
                </DropdownMenu>
